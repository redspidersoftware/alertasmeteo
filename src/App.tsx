  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto">
        <div className="py-8 px-4">
          ...
          <div className="mb-10 p-6 rounded-2xl bg-white/5 border border-white/10 text-center backdrop-blur-sm shadow-xl">
            <p className="text-slate-300 mb-6">{t('footer.donate_desc')}</p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <form action="https://www.paypal.com/donate" method="post" target="_blank" className="inline-block">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#0070ba] hover:bg-[#005ea6] text-white font-bold transition-all shadow-lg hover:shadow-[#0070ba]/20 group border-none cursor-pointer text-sm"
                >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#FFDD00] hover:bg-[#FFCC00] text-black font-bold transition-all shadow-lg hover:shadow-[#FFDD00]/20 group text-sm"
              >
                <img
      ...
      <footer className="py-8 text-center border-t border-white/5 mt-auto">
        <div className="max-w-7xl mx-auto px-4 flex flex-col items-center gap-2 text-slate-500 text-sm">
